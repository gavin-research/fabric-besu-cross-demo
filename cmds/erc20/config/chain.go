...
func (c *Chain) QueryAllowance(owner erc20mgrtypes.ID, spender erc20mgrtypes.ID) (*erc20mgrtypes.QueryAllowanceResponse, error) {
...
func (c *Chain) QueryBalanceOf(id erc20mgrtypes.ID) (*erc20mgrtypes.QueryBalanceOfResponse, error) {
