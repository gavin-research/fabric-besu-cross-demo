...
CHANNEL_NAME=erc20-channel
SIGNATURE_POLICY="AND('PlatformerMSP.peer','OrgAMSP.peer','OrgBMSP.peer')"
...
ORG_NAME="Platformer"
queryInstalled ${ORG_NAME}
commitChaincode ${ORG_NAME} ${CHANNEL_NAME} ${SIGNATURE_POLICY} "OrgA" "OrgB"
